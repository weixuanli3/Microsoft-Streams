...
#     registered_user_id = registered_user['u_id']
...
#     result_first_name = users_all_v1(registered_user_token)['names']
#     result_last_name = users_all_v1(registered_user_token)['names_last']
...
#     result_first_name = user_profile_v1(registered_user_id, registered_user_token)['names']
#     result_last_name = user_profile_v1(registered_user_id, registered_user_token)['names_last']
...
#     result = user_profile_v1(registered_user_id, registered_user_token)['emails']
...
#     user_profile_sethandle_v1(registered_user1_token, "johndoe")
...
#     result = user_profile_v1(registered_user_id, registered_user_token)['handle']
#     expected = "johnDoe"
