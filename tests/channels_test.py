...
#    
## The following tests channels_create_v2
## def test_channels_create_invalid_user_id():
##     clear_v1()
##     with pytest.raises(AccessError):
##         channels_create_v2(1, "First Channel", True)
#
## def test_channels_create_empty_channel_name():
##     clear_v1()
...
##     token = auth_register_v2("john.doe@aunsw.edu.au","password","John","Doe")['token']
##     with pytest.raises(InputError):
##         channels_create_v2(token, "Lengthofchanneltoolarge!", True)
#
## def test_channels_create_success_public():
##     clear_v1()
##     token = auth_register_v2("john.doe@aunsw.edu.au","password","John","Doe")['token']
##     channels_create_v2(token, "Channel 1", True)
#
## def test_channels_create_success_public():
##     clear_v1()
##     token = auth_register_v2("john.doe@aunsw.edu.au","password","John","Doe")['token']
##     channels_create_v2(token, "Channel 1", False)
#
## Call channels_list with no channels
## def test_channels_list_no_channels():
##     clear_v1()
...
##     chan1_id = channels_create_v2(user_data['token'], "Private Channel 1", False)['channel_id']
##     token = auth_register_v2("jade.lee@aunsw.edu.au","password","Jade","Lee")['token']
##     chan2_id = channels_create_v2(token, "Private Channel 2", False)['channel_id']
##     channel_invite_v2(token, chan2_id, user_data['user_id'])
##     assert channels_list_v2(user_data['token']) == {
##         'channels': [
##             {
##                 'channel_id': chan1_id,
##                 'name': 'Private Channel 1',
...
##     clear_v1()
##     user_data = auth_register_v2("john.doe@aunsw.edu.au","password","John","Doe")
##     chan1_id = channels_create_v2(user_data['token'], "Public Channel 1", False)['channel_id']
##     token = auth_register_v2("jade.lee@aunsw.edu.au","password","Jade","Lee")['token']
##     chan2_id = channels_create_v2(token, "Public Channel 2", False)['channel_id']
##     channel_invite_v2(token, chan2_id, user_data['user_id'])
##     assert channels_list_v2(user_data['token']) == {
##         'channels': [
##             {
...
##     clear_v1()
##     token = auth_register_v2("john.doe@aunsw.edu.au","password","John","Doe")['token']
##     chan1_id = channels_create_v2(token, "Public Channel 1", True)['channel_id']
##     chan2_id = channels_create_v2(token, "Public Channel 2", True)['channel_id']
##     assert channels_list_v2(token) == {
##         'channels': [
##             {
##                 'channel_id': chan1_id,
...
##     token = auth_register_v2("john.doe@aunsw.edu.au","password","John","Doe")['token']
##     chan1_id = channels_create_v2(token, "Public Channel 1", True)['channel_id']
##     chan2_id = channels_create_v2(token, "Private Channel 1", False)['channel_id']
##     assert channels_list_v2(token) == {
##         'channels': [
##             {
##                 'channel_id': chan1_id,
...
##     chan2_id = channels_create_v2(token, "Private Channel 2", False)['channel_id']
##     channel_invite_v2(token, chan2_id, user_data['user_id'])
##     assert channels_listall_v2(user_data['token']) == {
##         'channels': [
##             {
##                 'channel_id': chan1_id,
##                 'name': 'Private Channel 1',
...
##     chan1_id = channels_create_v2(token1, "Public Channel 1", False)['channel_id']
##     token2 = auth_register_v2("jade.lee@aunsw.edu.au","password","Jade","Lee")['token']
##     chan2_id = channels_create_v2(token2, "Public Channel 2", False)['channel_id']
##     channel_join_v2(token1, chan2_id)
...
##     chan2_id = channels_create_v2(token, "Private Channel 1", False)['channel_id']
##     channel_invite_v2(token, chan2_id, user_data['user_id'])
##     channel_join_v2(user_data['token'], chan1_id)
...
##     clear_v1()
##     token = auth_register_v2("john.doe@aunsw.edu.au","password","John","Doe")['token']
##     chan1_id = channels_create_v2(token, "Private Channel 1", False)['channel_id']
##     chan2_id = channels_create_v2(token, "Public Channel 1", True)['channel_id']
##     assert channels_listall_v2(token) == {
##         'channels': [
##             {
##                 'channel_id': chan1_id,
...
##     clear_v1()
##     with pytest.raises(AccessError):
##         channels_listall_v2(0)
#
## Call channels_list with both private and public channels
## def test_channels_list_channels_list_default():
##     clear_v1()
##     token1 = auth_register_v2("john.doe@aunsw.edu.au","password","John","Doe")['token']
##     chan_priv = channels_create_v2(token1, "Private Channel", False)['channel_id']
##     chan1_id = channels_create_v2(token1, "Public Channel 1", False)['channel_id']
##     token2 = auth_register_v2("jade.lee@aunsw.edu.au","password","Jade","Lee")['token']
##     chan2_id = channels_create_v2(token2, "Public Channel 2", False)['channel_id']
##     channel_join_v2(token1, chan2_id)
...
##     priv_user1_chan_id = channels_create_v2(token, "Private Channel 1", False)['channel_id']
##     priv_user2_chan_id = channels_create_v2(user_data['token'], "Private Channel 2", False)['channel_id']
##     pub_user1_chan_id = channels_create_v2(token, "Public Channel 1", True)['channel_id']
##     pub_user2_chan_id = channels_create_v2(user_data['token'], "Public Channel 2", True)['channel_id']
##     channel_join_v2(token, priv_user2_chan_id)
##     channel_join_v2(token, pub_user2_chan_id)
##     channel_invite_v2(token, priv_user1_chan_id, user_data['user_id'])
##     priv_user1_chan = {
##         'channel_id': priv_user1_chan_id,
##         'name': "Private Channel 1"
##     }
...
##         'channels': [priv_user1_chan, priv_user2_chan, pub_user2_chan]
##     }
##     assert channels_listall_v2(token) == channels_list_v1(token)
##     assert channels_listall_v2(user_data['token']) == channels_list_v1(token)
