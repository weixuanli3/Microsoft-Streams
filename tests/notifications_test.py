...
# from src.message import message_send_v1, message_senddm_v1, message_react_v1
...
#     own_handle_str = user_profile_v1(owner['token'], owner['auth_user_id'])['handle_str']
#     u1_handle_str = user_profile_v1(user1['token'], user1['auth_user_id'])['handle_str']
#     u2_handle_str = user_profile_v1(user2['token'], user2['auth_user_id'])['handle_str']
...
#     channels_create_v1(own_token, "Banter", True)

#     notifs = notifications_get_v1(own_token)
...
#     message_send_v1(own_tok, chan_id, f"@{u1_handle} @{u1_handle} @{u1_handle} hi")
#     assert notifications_get_v1(u1_tok) == {
#         [
#             {
#                 'channel_id': chan_id,
...
#         'channel_id': -1,
#         'dm_id': dm_id,
#         'notification_message': f"{u1_handle} added you to {dm_name}"
#     }
#     for i in range(1, 20):
#         assert owner_notifs[i] == {
#             'channel_id': -1,
#             'dm_id': dm_id,
#             'notification_message': f"{u1_handle} tagged you in {dm_name}: @{u1_handle} {lowcase[26 - i]} lol"
#         }
